...
<div id="content-container" class="about" bind:this={aboutSection1Container}>
	<div class="content-wrapper">
		...
		<div bind:this={paragraph}>
			<p class="paragraph">
				Working experience of 36 years at Tata Steel India in different functions. Expertise in Negotiation and Contracting for:- <br>1. Project Procurement. <br>2. Raw material sourcing from domestic and Import suppliers. <br>3. Logistics contracts execution for transportation thro multi mode on PTL and FTL. <br>4. Service contracts for all types of material handling work, Civil maintenance, Electrical system maintenance, canteen services, medicine and dispensary services etc. <br>5. Process consumables, Product consumables and Spares procurement for plant operstion.
<br><br>Managing the Procurement cost within the budget with various cost reduction measures.
			</p>
		</div>
		<div class="social-button-wrapper">
			<div bind:this={emailLink}>
				<span class="button"><a href="mailto:app@gmail.com" target="_blank" class="clickable sublink link">Email Me</a></span>
			</div>
			<div bind:this={githubLink}>
				<span class="button" bind:this={githubLink}><a href="https://in.linkedin.com/in/akhouri-p-prasad-415820169" target="_blank" class="clickable sublink link">Linkedln</a></span>
			</div>
		</div>
	</div>
	<div class="profile-image" bind:this={profilePicContainer}>
		{#await loadImage("assets/imgs/profile-photo.jpg") then src}
			<img src="{src}" bind:this={profilePicture} alt="APP's Cover" class="profile-pic">
		{/await}
	</div>
</div>
