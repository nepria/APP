	...
	<div class="content-wrapper">
		<div class="flex">
			<div class="flex-wrapper first">
				{#await loadImage("assets/imgs/signature-white.png") then src}
					<img src="{src}" bind:this={backgroundImage} draggable="false" alt="Home Background" style="width:60%; height: 40%; object-fit: cover;">
				{/await}
			</div>
			...
			<div class="flex-wrapper second">
				<h1 class = "title">
					<div class="title-mask">
						<div class="word" bind:this={titleWord1}>Akhouri</div>
					</div><br> 
					<div class="title-mask">
						<div class="word" bind:this={titleWord2}>Prasad</div>
					</div>
				</h1>
